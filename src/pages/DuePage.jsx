...
import { Phone, CheckSquare, Square, AlertTriangle, Send, ArrowLeft } from 'lucide-react';
import './DuePage.css';
                                        ...
                                        <td>
                                            <a
                                                ...
                                                onClick={(e) => {
                                                    ...
                                                    else setExcludedIds(prev => new Set(prev).add(c.id)); // Mark as sent for this session basically
                                                }}
                                            >
                                                <Phone size={16} />
                                            </a>
